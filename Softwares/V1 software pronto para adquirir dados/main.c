...
void ADC_Handler(void)
{
	...
	//ili93xx_draw_line(120, 110,120+50*cos(teta),110-50*sin(teta));
	...
	bmw=(int) result;
	PWM->PWM_CH_NUM[0].PWM_CDTY = bmw;
	result=100*(4096-result)/4096;
	ili93xx_set_foreground_color(COLOR_DARKBLUE);
	...
	ili93xx_draw_string(180, 50,  (uint8_t *)resultprint);
		...
		//ili93xx_draw_circle(120, 110, 50);
		//ili93xx_set_foreground_color(COLOR_SILVER);
		//teta=135-(((180/3.3)*result)/60);
		//ili93xx_draw_line(120, 110,120+50*cos(teta),110-50*sin(teta));
...
void lsd_setup(void)
{
	...
	ili93xx_set_foreground_color(COLOR_GOLD);
	ili93xx_draw_string(70, 20, (uint8_t *)"Leitura (V)");
	ili93xx_set_foreground_color(COLOR_TOMATO);
	ili93xx_draw_string(20, 170, (uint8_t *)"min V");
	ili93xx_set_foreground_color(COLOR_MAGENTA);
	ili93xx_draw_string(180, 170, (uint8_t *)"3V3");
	ili93xx_set_foreground_color(COLOR_YELLOW);
	ili93xx_draw_circle(120, 110, 50);
	*/
